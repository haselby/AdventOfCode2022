...
public class FoodInventoryTest {
    ...
    void searchMaxCaloriesHeldByElf_ExampleInputFile_ReturnsExpectedNumberOfCalories() throws IOException {
        ArrayList<Integer> puzzleInputTest01 = PuzzleInput.readIntoListOfIntegers("input_day01-01.txt");
    ...
    void searchMaxCaloriesHeldByTopThreeElves_ExampleInputFile_ReturnsExpectedNumberOfCalories() throws IOException {
        ArrayList<Integer> puzzleInputTest01 = PuzzleInput.readIntoListOfIntegers("input_day01-01.txt");
        FoodInventory foodInventoryTest = new FoodInventory(puzzleInputTest01);
